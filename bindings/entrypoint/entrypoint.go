...
// HandleAtomicOps is a paid mutator transaction binding the contract method 0x492205a6.
//
// Solidity: function handleAtomicOps((address,uint256,bytes,bytes,bytes32,uint256,bytes32,bytes,bytes)[] ops, address beneficiary) returns()
func (_EntryPoint *EntryPointTransactor) HandleAtomicOps(opts *bind.TransactOpts, ops []PackedUserOperation, beneficiary common.Address) (*types.Transaction, error) {
	return _EntryPoint.contract.Transact(opts, "handleAtomicOps", ops, beneficiary)
}

// HandleAtomicOps is a paid mutator transaction binding the contract method 0x492205a6.
//
// Solidity: function handleAtomicOps((address,uint256,bytes,bytes,bytes32,uint256,bytes32,bytes,bytes)[] ops, address beneficiary) returns()
func (_EntryPoint *EntryPointSession) HandleAtomicOps(ops []PackedUserOperation, beneficiary common.Address) (*types.Transaction, error) {
	return _EntryPoint.Contract.HandleAtomicOps(&_EntryPoint.TransactOpts, ops, beneficiary)
}

// HandleAtomicOps is a paid mutator transaction binding the contract method 0x492205a6.
//
// Solidity: function handleAtomicOps((address,uint256,bytes,bytes,bytes32,uint256,bytes32,bytes,bytes)[] ops, address beneficiary) returns()
func (_EntryPoint *EntryPointTransactorSession) HandleAtomicOps(ops []PackedUserOperation, beneficiary common.Address) (*types.Transaction, error) {
	return _EntryPoint.Contract.HandleAtomicOps(&_EntryPoint.TransactOpts, ops, beneficiary)
}
...
// InnerHandleOpAtomic is a paid mutator transaction binding the contract method 0xb3bd4acd.
//
// Solidity: function innerHandleOpAtomic(bytes callData, ((address,uint256,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256),bytes32,uint256,uint256,uint256) opInfo, bytes context) returns(uint256 actualGasCost)
func (_EntryPoint *EntryPointTransactor) InnerHandleOpAtomic(opts *bind.TransactOpts, callData []byte, opInfo EntryPointUserOpInfo, context []byte) (*types.Transaction, error) {
	return _EntryPoint.contract.Transact(opts, "innerHandleOpAtomic", callData, opInfo, context)
}

// InnerHandleOpAtomic is a paid mutator transaction binding the contract method 0xb3bd4acd.
//
// Solidity: function innerHandleOpAtomic(bytes callData, ((address,uint256,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256),bytes32,uint256,uint256,uint256) opInfo, bytes context) returns(uint256 actualGasCost)
func (_EntryPoint *EntryPointSession) InnerHandleOpAtomic(callData []byte, opInfo EntryPointUserOpInfo, context []byte) (*types.Transaction, error) {
	return _EntryPoint.Contract.InnerHandleOpAtomic(&_EntryPoint.TransactOpts, callData, opInfo, context)
}

// InnerHandleOpAtomic is a paid mutator transaction binding the contract method 0xb3bd4acd.
//
// Solidity: function innerHandleOpAtomic(bytes callData, ((address,uint256,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256),bytes32,uint256,uint256,uint256) opInfo, bytes context) returns(uint256 actualGasCost)
func (_EntryPoint *EntryPointTransactorSession) InnerHandleOpAtomic(callData []byte, opInfo EntryPointUserOpInfo, context []byte) (*types.Transaction, error) {
	return _EntryPoint.Contract.InnerHandleOpAtomic(&_EntryPoint.TransactOpts, callData, opInfo, context)
}
